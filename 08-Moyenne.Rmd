...
if (exists("assignment"))
  assignment("A08Ia_ttest", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/pe1zXXfq"),
    course.starts = c(
      'S-BIOG-027' = !"{W[27]+1} 13:00:00"),
    course.ends = c(
      'S-BIOG-027' = !"{W[28]+1} 23:59:59"),
    term = "Q2", level = 3,
...
if (exists("assignment2"))
  assignment2("A07Ga_human", part = "II",
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/M2cmViW4"),
    course.starts = c(
      'S-BIOG-027' = !"{W[25]+1} 13:00:00"),
    course.ends = c(
      'S-BIOG-027' = !"{W[36]+2} 23:59:59"),
    term = "Q2", level = 4, n = 4,
    toc = "Biométrie humaine, part II")
```

```{=html}
<!-- **Note : Le projet suivant est la continuité d'un exercice débuté au premier quadrimestre et approfondi au module précédent.**
