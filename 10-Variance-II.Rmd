...
```{r assign_A10Ia_anova2_II, echo=FALSE, results='asis'}
if (exists("assignment"))
...
Attention : rappelez-vous ici que `sgroup_by()` et `ssummarise()` ne sont pas compatibles avec `n()`.
...
Vous pouvez aussi utiliser la fonction "speedy" `smutate()` de `SciViews::R` bien sûr :
...
```{r assign_A07Ga_human_IV, echo=FALSE, results='asis'}
