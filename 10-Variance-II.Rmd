...
`r h5p(113, height = 400, toc = "Modèle croisé complet")`
...
if (exists("assignment"))
  assignment("A10Ia_anova2", part = "I",
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/PhjeqYK9"),
    course.starts = c(
...
Dans cette dernière section du module \@ref(variance2), nous revenons sur nos outils logiciels. C'est bien de connaître les techniques de visualisation et d'analyse des données, mais c'est encore mieux de pouvoir les appliquer en pratique... et pour cela il faut maîtriser un ou plusieurs logiciels. Nous avons utilisé principalement **[R](https://www.r-project.org)**, avec l'interface proposée par RStudio. Nous allons maintenant approfondir quelque peu nos connaissances en R.
...
```{=html}
<!-- no more ! **Revenez sur votre projet trans-modules sur `urchin` et ajoutez-y une ANOVA à deux facteurs. Avancez également dans la rédaction du rapport de votre analyse (fichier `docs/urchin_report.Rmd`). Ce projet devra être terminé au prochain module**
...
if (exists("challenge"))
  challenge("A10Ca_infer", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/IMEWk4zD"),
    course.starts = c(
      'S-BIOG-027' = !"{W[35]+5} 10:00:00"),
    course.ends = c(
      'S-BIOG-027' = !"{W[35]+5} 13:00:00"),
