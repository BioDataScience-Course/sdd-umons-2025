...
if (exists("assignment"))
  assignment("A03Ia_graphe_avance", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/f4nCD4Zh"),
    course.starts = c(
...
Vous utilisez le logiciel que vous voulez pour créer ce diagramme. Les logiciels de "mind mapping" tels que [Coggle](https://coggle.it) se prêtent très bien à cet exercice. Une fois votre document terminé, placez-le dans le dépôt GitHub suivant afin que vous puissiez rapidement le récupérer. **Nous vous conseillons de garder ce document à disposition plus tard lorsque vous aurez des graphiques à réaliser.**
...
if (exists("challenge"))
  challenge("A03Ca_charts", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/2zwrzeng"),
    course.starts = c(
      'S-BIOG-006' = !"{W[10]+5} 09:45:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[10]+5} 11:30:00"),
