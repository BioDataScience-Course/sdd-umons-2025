...
if (exists("assignment"))
  assignment("A04Ia_transformation", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-006' = "https://classroom.github.com/a/-_PWUcb4"),
    course.starts = c(
      'S-BIOG-006' = !"{W[12]+1} 13:00:00"),
    course.ends = c(
      'S-BIOG-006' = !"{W[13]+1} 23:59:59"),
    term = "Q1", level = 3,
...
```{block, type='bdd'}
Réalisez dans le projet sur le zooplancton les exercices suivants :
