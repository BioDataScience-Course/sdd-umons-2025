...
En termes plus simples, le test Chi^2^ univarié permet de vérifier si le nombre de fois que les différents niveaux d'une variable qualitative apparaissent dans un échantillon est significativement différent ou non de ce à quoi on s'attend (probabilités définies *a priori* sous H~0~, ici, probabilités de 50% pour chaque variété).
...
if (exists("assignment"))
  assignment("A07Ia_pea", part = NULL,
    ...
    course.urls = c(
      'S-BIOG-027' = "https://classroom.github.com/a/G-X1A4ga"),
    course.starts = c(
...
```{r assign_A07Ga_human_I, echo=FALSE, results='asis'}
